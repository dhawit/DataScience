...
library(stringi)
library(scales)
setwd("/Users/dhawit/Desktop/Dhawit_210407_DataScience")

#Broadband Data Cleaning

Broadband<- read_csv("/Users/dhawit/Desktop/Dhawit_210407_Data_Science/Datasets/Broadband_Speed/201805_fixed_pc_performance_r03.csv", show_col_types = FALSE)
